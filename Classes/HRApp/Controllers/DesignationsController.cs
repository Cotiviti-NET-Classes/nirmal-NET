...
namespace HRApp.Controllers
{
    public class DesignationsController : Controller
    {
        ...
        public DesignationsController(HRAppContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("DesignationID,DesignationName,Salary")] Designation designation)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("DesignationID,DesignationName,Salary")] Designation designation)
        {
